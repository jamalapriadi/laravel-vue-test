    ...
    <div class="card card-accent-primary">
        <div class="card-header">
            ...
            <div class="card-header-actions">
                <router-link to="/add-new-storing-retur" class="btn btn-primary">
            ...
            <table class="table table-striped">
                ...
                <tbody>
                    <tr v-for="(l, index) in list.data" v-bind:key="index">
                        ...
                        <td>
                            <div class="btn-group">
                                <router-link :to="{ name: 'storingReturDetail', params: {id: l.no_storing}}" class="btn btn-info">
    ...
    export default {
        ...
        methods: {
            ...
            showData(page){
                ...
                axios.get('data/storingretur?page='+page)
                    .then(response => {
                        this.loading=false;
                        this.list = response.data;
            ...
            cariData(page){
                ...
                axios.get('/data/storingretur?q='+this.pencarian)
                    .then(response => {
                        this.list = response.data;
                    })
                    .catch( errors => {
            ...
            hapus(id,index,name){
                ...
                .then((result) => {
                    if(result.value) {
                        axios.delete('/data/storingretur/'+id)
                            .then(response => {
