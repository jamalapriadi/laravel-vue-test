    ...
    <div class="card card-accent-primary">
        <div class="card-header">
            ...
            <div class="card-header-actions">
                <router-link to="/add-new-stok-opname" class="btn btn-primary">
            ...
            <table class="table table-striped">
                ...
                <tbody>
                    <tr v-for="(l, index) in list.data" v-bind:key="index">
                        ...
                        <td>
                            <div class="btn-group">
                                <router-link :to="{ name: 'stopopnameDetail', params: {id: l.no_so}}" class="btn btn-info">
                                    <i class="fa fa-list text-white"></i>
                                </router-link>

                                <!-- <a class="btn btn-danger" v-on:click="hapus(l.no_so, index, l.nm)" v-bind:id="'delete'+l.no_po">
    ...
    export default {
        ...
        methods: {
            ...
            showData(page){
                ...
                axios.get('data/stok-opname?page='+page)
                    .then(response => {
                        this.loading=false;
                        this.list = response.data;
            ...
            cariData(page){
                ...
                axios.get('/data/stok-opname?q='+this.pencarian)
                    .then(response => {
                        this.list = response.data;
                    })
                    .catch( errors => {
            ...
            hapus(id,index,name){
                ...
                .then((result) => {
                    if(result.value) {
                        axios.delete('/data/stok-opname/'+id)
                            .then(response => {
