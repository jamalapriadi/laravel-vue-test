                    ...
                    <tr v-for="(l, index) in list.data" v-bind:key="index">
                        ...
                        <td>
                            <div class="btn-group">
                                ...
                                <a class="btn btn-danger" v-on:click="hapus(l.kd_bank, index, l.nm)" v-bind:id="'delete'+l.kd_bank">
    ...
    export default {
        ...
        methods: {
            ...
            cariData(page){
                ...
                axios.get('/data/bank?q='+this.pencarian)
                    .then(response => {
                        this.list = response.data;
                    })
                    .catch( errors => {
