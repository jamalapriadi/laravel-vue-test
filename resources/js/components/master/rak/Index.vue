            ...
            <table class="table table-striped">
                ...
                <tbody>
                    <tr v-for="(l, index) in list.data" v-bind:key="index">
                        ...
                        <td>
                            <div class="btn-group">
                                <router-link :to="{ name: 'rakEdit', params: {id: l.kd}}" class="btn btn-warning">
    ...
    export default {
        ...
        methods: {
            ...
            cariData(page){
                ...
                axios.get('/data/rak?q='+this.pencarian)
                    .then(response => {
                        this.list = response.data;
                    })
                    .catch( errors => {
