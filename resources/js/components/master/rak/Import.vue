    ...
    <div class="container">
        <div class="card card-accent-primary">
            ...
            <div class="card-body">
                ...
                <form @submit.prevent="store" action="/data/import-new-rak" method="post" enctype="multipart/form-data">
                    ...
                    <breadcrumbs>
                        Berikut adalah sample data rak yang bisa anda gunakan sebagai format
                        standar untuk import data rak : <a href="/data/sample-rak">Klik di sini</a>
                    </breadcrumbs>
