    ...
    <div class="card card-accent-primary">
        <div class="card-header">
            ...
            <div class="card-header-actions">
                <router-link to="/add-perusahaan" class="btn btn-primary">
            ...
            <table class="table table-striped">
                ...
                <tbody>
                    <tr v-for="(l, index) in list.data" v-bind:key="index">
                        ...
                        <td>
                            <div class="btn-group">
                                <router-link :to="{ name: 'perusahaanEdit', params: {id: l.id}}" class="btn btn-warning">
    ...
    export default {
        ...
        methods: {
            ...
            showData(page){
                ...
                axios.get('data/perusahaan?page='+page)
                    .then(response => {
                        this.loading=false;
                        this.list = response.data;
            ...
            cariData(page){
                ...
                axios.get('/data/perusahaan?q='+this.pencarian)
                    .then(response => {
                        this.list = response.data;
                    })
                    .catch( errors => {
            ...
            hapus(id,index,name){
                ...
                .then((result) => {
                    if(result.value) {
                        axios.delete('/data/perusahaan/'+id)
                            .then(response => {
