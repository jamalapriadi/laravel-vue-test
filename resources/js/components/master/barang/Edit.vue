...
export default {
    ...
    methods: {
        getData(){
            ...
            axios.get('/data/barang/'+id)
                .then(response => {
                    this.state.kode = response.data.kd;
                    this.state.nama = response.data.nm;
                    this.state.kelompok = response.data.kelompok_id;
                    this.state.merk = response.data.merk_id;
                    this.state.satuan = response.data.satuan;
                    this.state.status = response.data.status;
                    this.state.pcs = response.data.pcs;
                    this.state.hrgb = response.data.hrgb;
                    this.state.hrgp = response.data.hrgp;
                    this.state.jual = response.data.jual;
                })
                .catch( error => {
        ...
        saveForm(){
            ...
            axios.patch('/data/barang/'+this.kelompokId, newState)
                .then(response => {
                    this.$router.replace('/barang');
                })
                .catch( error => {
