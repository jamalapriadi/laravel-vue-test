    ...
    <div class="card card-accent-primary">
        <div class="card-header">
            ...
            <div class="card-header-actions">
                <router-link to="/add-suplier" class="btn btn-primary">
            ...
            <table class="table table-striped">
                ...
                <tbody>
                    <tr v-for="(l, index) in list.data" v-bind:key="index">
                        ...
                        <td>{{l.kota.nm}}</td>
                        <td>{{l.telepon}}</td>
                        <td>{{l.nm_perusahaan}}</td>
                        <td>{{l.kontak}}</td>
                        <td>{{l.fax}}</td>
                        <td>
                            <div class="btn-group">
                                <router-link :to="{ name: 'suplierEdit', params: {id: l.kd}}" class="btn btn-warning">
                                    <i class="fa fa-edit text-white"></i>
                                </router-link>

                                <a class="btn btn-danger" v-on:click="hapus(l.kd, index, l.nm)" v-bind:kd="'delete'+l.id">
    ...
    export default {
        ...
        methods: {
            ...
            showData(page){
                ...
                axios.get('data/suplier?page='+page)
                    .then(response => {
                        this.loading=false;
                        this.list = response.data;
            ...
            cariData(page){
                ...
                axios.get('/data/suplier?q='+this.pencarian)
                    .then(response => {
                        this.list = response.data;
                    })
                    .catch( errors => {
